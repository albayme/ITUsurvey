...
class AddActivityScreen extends GetWidget<AddActivityController> {
            ...
            child: Scaffold(
                ...
                bottomNavigationBar: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Obx(() => controller.activeCurrentStep.value == 3
                              ? CustomButton(
                  ...
                  () => Container(
                    ...
                    child: Stepper(
                        ...
                        onStepTapped: (int index) {
                          ...
                          if (controller.activeCurrentStep.value == 1) {
                            controller.updateStep2();
                          }
                        },
  ...
  Widget _step1() {
    return SizedBox(
      height: 525,
      child: Obx(() => controller.showMap.value
                  ...
                  Obx(() => controller.toggle.value || !controller.toggle.value
                      ? GoogleMap(
                          ...
                          onMapCreated: (GoogleMapController c) {
                            if (!controller.mapC.isCompleted) {
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  controller.currentPosition.value[0]
                                      .toString(),
                                  textAlign: TextAlign.end,
                                ),
                                Text(
                                  controller.currentPosition.value[1]
                                      .toString(),
                                  textAlign: TextAlign.end,
                                ),
                              ],
  ...
  Widget _renderSteps() {
    return controller.toggleExpansion.value ||
            !controller.toggleExpansion.value && controller.itemData.length > 0
        ? Container(
                    ...
                    ExpansionPanel(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            CustomTextFormField(
                                ...
                                focusNode: FocusNode(),
                                controller:
                                    controller.pinDetailsController[index],
                            ...
                            CustomTextFormField(
                                ...
                                controller: controller
                                    .studentNoteOnPinsController[index],
                                label: "Student Explanations".tr,
                                margin: getMargin(top: 8, bottom: 2),
                                padding: TextFormFieldPadding.PaddingTB25,
                                fontStyle:
                                    TextFormFieldFontStyle.UrbanistSemiBold16,
                      ...
                      headerBuilder: (BuildContext context, bool isExpanded) {
                        return Container(
                            padding: const EdgeInsets.all(10),
                            child: Text(
                              controller.itemData.value[index].headerItem,
                              style: const TextStyle(
                                fontSize: 16,
                              ),
                            ));
                      },
                      isExpanded: controller.itemData.value[index].expanded,
                    )
                  ],
                  expansionCallback: (int item, bool status) {
                    controller.itemData.value[index].expanded =
                        !controller.itemData.value[index].expanded;
                    controller
                        .toggleExpansion(!controller.toggleExpansion.value);
                  },
                );
              },
            ),
  ...
  Widget _step2() {
    return Obx(() => SizedBox(height: 500, child: _renderSteps()));
  }
      ...
      child: Column(
        ...
        children: [
          ...
          controller.position.length ==
                  controller.studentNoteOnPinsController.length
              ? SizedBox(
                  height: 400,
                  child: ListView.builder(
                    physics: const BouncingScrollPhysics(),
                      ...
                      return Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                                "Activitiy: ${controller.studentNoteOnPinsController.value[index].text.toString()}"),
                          ],
                        ),
                      );
                    },
  ...
  Future<void> _add() async {
    ...
    controller.numberOfCurrenctPin.value += 1;
